...
import type { Offer } from '../../types/clubDesk'

function formatFee(offer: Offer): string {
...
export default function InboxPage() {
  ...
  const { offers, total, status, error, query } = useAppSelector((s) => s.inbox)
  const selected = useAppSelector((s) => s.selection.selectedOfferIds)
